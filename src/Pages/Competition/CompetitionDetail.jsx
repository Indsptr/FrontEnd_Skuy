    ...
    <div className="container">
      <div className="p-3">
        ...
        <div className="gambar">
          <img src={`${import.meta.env.VITE_BACKEND_URL}/${competition.image_lomba}`} alt="Competition Image" style={{
            height: '100%',
            maxHeight: '400px'
          }} />
        </div>
        <div className="content">
          ...
          <div className="statistics">
            <span className="statistic-item">
              <i className="icon-eye"></i> {competition.views} Dilihat oleh orang
            </span>
            <span className="statistic-item">
